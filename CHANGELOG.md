...
* [ENHANCEMENT] #436 Upgrade Stargate to 1.0.13. Added `stargate.preStopDelaySecconds` with default of 20, which improves Stargate's availability during scale-down operations. 
