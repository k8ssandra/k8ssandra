...
![Version: 1.5.1-SNAPSHOT](https://img.shields.io/badge/Version-1.5.1--SNAPSHOT-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| cassandra.version | string | `"4.0.3"` | The Cassandra version to use. The supported versions include the following:    - 3.11.7    - 3.11.8    - 3.11.9    - 3.11.10    - 3.11.11    - 3.11.12    - 4.0.0    - 4.0.1    - 4.0.3 |
| cassandra.versionImageMap | object | `{"3.11.10":"k8ssandra/cass-management-api:3.11.10-v0.1.27","3.11.11":"k8ssandra/cass-management-api:3.11.11-v0.1.37","3.11.12":"k8ssandra/cass-management-api:3.11.12-v0.1.37","3.11.7":"k8ssandra/cass-management-api:3.11.7-v0.1.37","3.11.8":"k8ssandra/cass-management-api:3.11.8-v0.1.37","3.11.9":"k8ssandra/cass-management-api:3.11.9-v0.1.27","4.0.0":"k8ssandra/cass-management-api:4.0.0-v0.1.37","4.0.1":"k8ssandra/cass-management-api:4.0.1-v0.1.37","4.0.3":"k8ssandra/cass-management-api:4.0.3-v0.1.37"}` | Specifies the image to use for a particular Cassandra version. Exercise care and caution with changing these values! cass-operator is not designed to work with arbitrary Cassandra images. It expects the cassandra container to be running management-api images. If you do want to change one of these mappings, the new value should be a management-api image. |
