...
![Version: 0.43.0](https://img.shields.io/badge/Version-0.43.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 3.11.7](https://img.shields.io/badge/AppVersion-3.11.7-informational?style=flat-square)
...
| cassandra.clusterName | string | `""` | Cassandra cluster_name parameter in cassandra.yaml |
