...
| cassandra.resources | object | `{}` | Cluster-level heap configuration (optional). See reference: https://k8ssandra.io/docs/reference/k8ssandra/#values for additional information. size: newGenSize: -- Resource requests for each Cassandra pod. |
