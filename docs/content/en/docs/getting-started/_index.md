...
* Cassandra Reaper:
    <http://repair.127.0.0.1.nip.io:8080/webui>
* Prometheus:
    <http://127.0.0.1.nip.io:8080/prometheus/graph>
* Grafana (login as `admin` with password `admin123`):
    <http://127.0.0.1.nip.io:8080/grafana/login>
