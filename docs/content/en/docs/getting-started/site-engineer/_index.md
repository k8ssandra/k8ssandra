...
You can easily upgrade your K8ssandra software with the `helm repo update` command, or apply new settings with the `helm upgrade` command. For details, see [Upgrade K8ssandra]({{< ref "/docs/topics/upgrade/" >}}).

## Next

See the K8ssandra [task-based]({{< ref "/docs/topics/" >}}) topics. 
