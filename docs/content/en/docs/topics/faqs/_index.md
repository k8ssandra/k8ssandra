...
To get started, `cd` to the downloaded `k8ssandra` directory, and enter these commands:
...
Read other [topics](/docs/topics) in the documentation, and actively participate in the [community](https://k8ssandra.io/community/) of K8ssandra users.
