...
| image.tag | string | `"v0.4.0"` | Tag of the medusa-operator image to pull from image.repository |
...
| podSecurityContext | object | `{}` | SecurityContext for the medusa-operator pod. |
| securityContext | object | `{"readOnlyRootFilesystem":true,"runAsGroup":65534,"runAsNonRoot":true,"runAsUser":65534}` | SecurityContext for the medusa-operator container. |
